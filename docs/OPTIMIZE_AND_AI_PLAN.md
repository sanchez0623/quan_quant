...
> 状态：方案 A 已实现；方案 B Phase 1 已实现（2026-09-04：诊断引擎+数据加厚+验证闭环+实盘AI简报点评），Phase 2/3 待实现；下钻工具已实现（2026-09-04：query\_trades / get\_code\_profile / get\_market\_context 只读取证 + 预算护栏 + 不支持 tools 的端点自动降级，见 llm/drilldown.py）
